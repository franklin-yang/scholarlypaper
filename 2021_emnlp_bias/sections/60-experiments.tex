...
\begin{figure*}[h]
	...
	\caption{ These occupations resulted in significantly different gender distributions between the QANTA dataset and the retriever results.}
\end{figure*}
